                    ...
                    <div className="lg:grid lg:grid-cols-6 gap-20">
                        <div className="col-span-3">
                            <div className="flex items-center space-x-5">
                                <img src="/img/round.png" className="rounded-full w-12" />
                                <p className="font-semibold text-xl text-white">Flare</p>
                            </div>
...
<a href="https://top.gg/bot/1032300215664914523">
  <img src={"https://top.gg/api/widget/servers/1032300215664914523.svg"}/>
</a>
<div className="py-1"></div>
<a href="https://top.gg/bot/1032300215664914523">
  <img src={"https://top.gg/api/widget/upvotes/1032300215664914523.svg"}/>
</a>
<div className="py-1"></div>
<a href="https://top.gg/bot/1032300215664914523">
  <img src={"https://top.gg/api/widget/owner/1032300215664914523.svg"}/>
</a>
                                </div>
                            </Menu>
                    ...
                    <div className="mt-10 grid content-center grid-cols-1 sm:grid-cols-2 md:grid-cols-3">
                        <p className="text-white text-center sm:text-left text-opacity-50">
                            {new Date().getFullYear()} &copy; Flare
                        </p>
